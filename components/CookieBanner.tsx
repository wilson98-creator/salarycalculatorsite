...
export function CookieBanner() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-3 bottom-3 z-50 max-w-3xl rounded-2xl border border-ink-200 bg-white p-4 shadow-lg sm:bottom-4 sm:left-4 sm:right-4"
    >
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="text-sm text-ink-700">
          ...
          <p>
            ...
            <a href="/privacy" className="text-brand-600 underline-offset-2 hover:underline">Privacy policy</a>
          </p>
        </div>
